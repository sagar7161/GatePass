...
import com.example.gatepass.Adapter.LeaveAdapter;
import com.example.gatepass.History.HrHistoryActivity;
...
public class HRActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        history.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HRActivity.this, HrHistoryActivity.class);
        ...
        mAdapter = new LeaveAdapter(this,modelLeaves);
    ...
    private void checkLogin() {
        ...
        if (sharedId.equals(null)){
            Intent startIntent = new Intent(HRActivity.this, MainActivity.class);
